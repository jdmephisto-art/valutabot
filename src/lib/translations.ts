...
export const currencyNames = {
  en: {
    ...
    "BCH": "Bitcoin Cash", "BDT": "Bangladeshi Taka", "BGN": "Bulgarian Lev", "BHD": "Bahraini Dinar",
    "BIF": "Burundian Franc", "BMD": "Bermudan Dollar", "BND": "Brunei Dollar",
    "BOB": "Bolivian Boliviano", "BRL": "Brazilian Real", "BSD": "Bahamian Dollar",
    "BTC": "Bitcoin", "BTG": "Bitcoin Gold", "BTN": "Bhutanese Ngultrum", "BWP": "Botswanan Pula",
    ...
    "DASH": "Dash", "DJF": "Djiboutian Franc", "DKK": "Danish Krone", "DOP": "Dominican Peso",
    "DZD": "Algerian Dinar", "EGP": "Egyptian Pound", "EOS": "EOS", "ERN": "Eritrean Nakfa",
    "ETB": "Ethiopian Birr", "ETH": "Ethereum", "EUR": "Euro", "FJD": "Fijian Dollar",
    ...
    "LSL": "Lesotho Loti", "LTC": "Litecoin", "LYD": "Libyan Dinar", "MAD": "Moroccan Dirham",
  ...
  ru: {
    ...
    "BCH": "Биткоин Кэш", "BDT": "Бангладешская така", "BGN": "Болгарский лев", "BHD": "Бахрейнский динар",
    ...
    "BTC": "Биткоин", "BTG": "Биткоин Голд", "BTN": "Бутанский нгултрум", "BWP": "Ботсванская пула",
    ...
    "DASH": "Дэш", "DJF": "Джибутийский франк", "DKK": "Датская крона", "DOP": "Доминиканское песо",
    "DZD": "Алжирский динар", "EGP": "Египетский фунт", "EOS": "ЭОС", "ERN": "Эритрейская накфа",
    "ETB": "Эфиопский быр", "ETH": "Эфириум", "EUR": "Евро", "FJD": "Фиджийский доллар",
    ...
    "KPW": "Северокорейская вона", "KRW": "Вон Республики Корея", "KWD": "Кувейтский динар",
    ...
    "LSL": "Лоти Лесото", "LTC": "Лайткоин", "LYD": "Ливийский динар", "MAD": "Марокканский дирхам",
    ...
    "TZS": "Тanzanian Shilling", "UAH": "Украинская гривна", "UGX": "Угандийский шиллинг",
