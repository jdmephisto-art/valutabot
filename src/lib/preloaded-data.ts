...
export const nbrbPreloadedCurrencies: Currency[] = [
    ...
    { code: 'KRW', name: 'Вон Республики Корея' },
].sort((a, b) => a.code.localeCompare(b.code));

export const currencyApiPreloadedCurrencies: Currency[] = [
