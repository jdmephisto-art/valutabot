...
async function updateCurrencyApiRatesCache(baseCurrency = 'USD') {
    ...
    if (data && data.data) {
        const tempCache = {};
        Object.entries(data.data).forEach(([code, rateData])=>{
...
async function getCurrencyApiDynamicsForPeriod(from, to, startDate, endDate) {
    ...
    const promises = [];
    for(let d = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["startOfDay"])(startDate); d <= endDate; d = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addDays"])(d, 1)){
    ...
    return resultsWithDate.map((res)=>({
            date: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(res.date, 'dd.MM'),
            rate: res.rate
        }));
}
// --- NBRB PROVIDER ---
...
async function getNbrbCurrencies() {
    ...
    if (nbrbCurrenciesCache) {
        const currencies = nbrbCurrenciesCache.map(({ id, dateEnd, ...rest })=>rest);
...
//# sourceMappingURL=src_b3ceae89._.js.map