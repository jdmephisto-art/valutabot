...
function LatestRates() {
    _s();
    const [rates, setRates] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currencies$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getInitialRates"]);
        ...
        "LatestRates.useEffect": ()=>{
            const interval = setInterval({
                "LatestRates.useEffect.interval": ()=>{
                    const newRates = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currencies$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLatestRates"])();
                    const changed = new Map();
                    for (const newRate of newRates){
                        const oldRate = rates.find({
                            "LatestRates.useEffect.interval.oldRate": (r)=>r.from === newRate.from && r.to === newRate.to
                        }["LatestRates.useEffect.interval.oldRate"]);
                        if (oldRate && oldRate.rate !== newRate.rate) {
                            changed.set("".concat(newRate.from, "-").concat(newRate.to), newRate.rate > oldRate.rate ? 'up' : 'down');
                        }
                    }
                    setRates(newRates);
            ...
            }["LatestRates.useEffect.interval"], 3000);
            return ({
...
_s(LatestRates, "Gk0BDkT/A8H7Z+QoL3h5q3gQ5Js=");
_c = LatestRates;
var _c;
...
function ChatInterface() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatInterface.useEffect": ()=>{
            const checkAlerts = {
                "ChatInterface.useEffect.checkAlerts": ()=>{
                    if (alerts.length === 0) return;
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currencies$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLatestRates"])(); // to update rates
                    const triggeredAlerts = [];
                    const remainingAlerts = [];
                    alerts.forEach({
                        "ChatInterface.useEffect.checkAlerts": (alert)=>{
...
_s(ChatInterface, "zO9rHGesbmgbQzbTYOwN4Lo279Y=", false, function() {
    return [
...
//# sourceMappingURL=src_aae0fb04._.js.map