...
function getCurrencyName(code, language) {
    ...
    if (!name && language === 'ru') {
        const englishNames = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$translations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["currencyNames"]['en'];
        name = englishNames === null || englishNames === void 0 ? void 0 : englishNames[code];
    }
...
function FirebaseProvider(param) {
    let { children, app, firestore, auth } = param;
...
_s(useFirebaseApp, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
const useFirestore = ()=>{
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(FirebaseContext);
...
;
class ErrorEmitter extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$events$2f$events$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EventEmitter"] {
    emit(event, error) {
...
function FirebaseErrorListener() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FirebaseErrorListener.useEffect": ()=>{
            ...
            return ({
                "FirebaseErrorListener.useEffect": ()=>{
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$error$2d$emitter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["errorEmitter"].removeListener('permission-error', handlePermissionError);
                }
            })["FirebaseErrorListener.useEffect"];
        }
    }["FirebaseErrorListener.useEffect"], [
...
function FirebaseClientProvider(param) {
    let { children } = param;
    _s();
    const { app, firestore, auth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
...
_s(FirebaseClientProvider, "qBejSDVLrfklJvgyXjHAL9J294U=");
...
class FirestorePermissionError extends Error {
    constructor(context){
        super("FirestoreError: Missing or insufficient permissions: The following request was denied by Firestore Security Rules: ".concat(JSON.stringify(context, null, 2))), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "context", void 0);
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(query, {
                ...
                "useCollection.useEffect.unsubscribe": async (serverError)=>{
                    ...
                    const permissionError = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FirestorePermissionError"]({
                        path: ((__query = query._query) === null || __query === void 0 ? void 0 : (__query_path = __query.path) === null || __query_path === void 0 ? void 0 : __query_path.toString()) || 'unknown',
                        operation: 'list'
                    });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useDoc.useEffect": ()=>{
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(ref, {
                ...
                "useDoc.useEffect.unsubscribe": async (serverError)=>{
                    const permissionError = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FirestorePermissionError"]({
                        path: ref.path,
                        operation: 'get'
                    });
...
function initializeFirebase() {
    const app = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeFirebaseApp"])();
...
//# sourceMappingURL=src_4730620c._.js.map