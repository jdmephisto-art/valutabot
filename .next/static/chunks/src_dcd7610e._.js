...
function getCurrencyApiKey() {
    const apiKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_CURRENCY_API_KEY;
...
async function currencyApiFetch(endpoint) {
    ...
    const url = new URL("".concat(CURRENCY_API_BASE_URL, "/").concat(endpoint));
...
async function updateCurrencyApiRatesCache() {
    ...
    if (data && data.data) {
        const tempCache = {};
        Object.entries(data.data).forEach((param)=>{
            let [code, rateData] = param;
...
async function getCurrencyApiLatestRates() {
    if (Date.now() - lastCurrencyApiFetchTimestamp > 60 * 60 * 1000) {
        await updateCurrencyApiRatesCache('USD');
    }
...
async function getCurrencyApiDynamicsForPeriod(from, to, startDate, endDate) {
    ...
    const promises = [];
    for(let d = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfDay"])(startDate); d <= endDate; d = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDays"])(d, 1)){
        const currentDate = new Date(d);
        promises.push(getCurrencyApiHistoricalRate(from, to, currentDate).then((rate)=>({
                date: currentDate,
                rate
            })));
    }
    ...
    return resultsWithDate.map((res)=>({
            date: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(res.date, 'dd.MM'),
            rate: res.rate
        }));
}
// --- NBRB PROVIDER ---
...
async function nbrbApiFetch(endpoint) {
    try {
        const response = await fetch("".concat(NBRB_API_BASE_URL, "/").concat(endpoint));
        if (!response.ok) {
...
async function getNbrbCurrencies() {
    ...
    if (nbrbCurrenciesCache) {
        const currencies = nbrbCurrenciesCache.map((param)=>{
            let { id, dateEnd, ...rest } = param;
            return rest;
        });
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                        children: "Real-time data from CurrencyAPI"
                    }, void 0, false, {
                        fileName: "[project]/src/components/latest-rates.tsx",
                        lineNumber: 50,
                        columnNumber: 9
...
//# sourceMappingURL=src_dcd7610e._.js.map